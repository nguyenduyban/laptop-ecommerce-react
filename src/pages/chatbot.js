...
const Chatbot = () => {
  ...
  useEffect(() => {
    axios
      .get(`https://ecommerce-laravel.up.railway.app/api/messages/${userId}`)
      .then((res) => {
  ...
  const sendMessage = async () => {
    ...
    try {
      let res;
      if (mode === "bot") {
        res = await axios.post("https://ecommerce-laravel.up.railway.app/api/chatbot", {
          message: trimmed,
          user_id: userId,
        });
        ...
        res = await axios.post("https://ecommerce-laravel.up.railway.app/api/send", {
          message: trimmed,
          user_id: userId,
        });

          ...
          <div className="col-lg-9">
            ...
            <div className="d-flex flex-wrap gap-2 mb-4">
              {brands.map((b) => (
                ...
                >
                  <img
                    src={`https://ecommerce-laravel.up.railway.app/storage/img/${b.hinhanh}`}
                    alt={b.tenhang}
            ...
            <div className="mb-4">
              ...
              <div className="d-flex flex-wrap gap-3">
                {categories.map((cat) => (
                  ...
                  >
                    <img
                      src={`https://ecommerce-laravel.up.railway.app/storage/img/${cat.hinhanh}`}
                      alt={cat.tendanhmuc}
                                ...
                                >
                                  ...
                                  >
                                    <div className="bg-white rounded-3 p-3 text-center shadow-sm h-100 d-flex flex-column justify-content-between">
                                      <div className="mb-2">
                                        <img
                                          src={`https://ecommerce-laravel.up.railway.app/storage/img/${p.anhdaidien}`}
                                          alt={p.tensp}
                                          className="img-fluid"
                                          style={{
                                            height: "90px",
